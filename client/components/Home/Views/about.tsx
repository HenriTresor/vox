...
const AboutUs = (props: Props) => {
    return (
        ...
        >
            <div className='w-1/2 h-full bg-none border-r-8 border-black rounded-tr-full text-black hidden md:flex items-center justify-center text-[3rem] tracking-wider'>
            ...
            <div className='md:w-1/2 w-full p-4 grid grid-cols-2 gap-5 h-full place-content-center'>
            {
                    reasons.map(item => {
                        return (
                            <Card key={item.title}>
